...
DoMultiBarHeatmap <- function (object = pbmc_new, 
                               features = regulonlist_vector, 
                               cells = NULL, 
                               group.by = "Megaclusters", 
                               additional.group.by = "Study", 
  ...
  for (i in group.by) {
    ...
    if (group.bar) {
      ...
      for (colname in rev(x = colnames(group.use2))) {
        ...
        # Default
        cols[[colname]] <- c("#FF40FF", "#FF0000", "#AC0056", "#1CB0F0", "#E8B002", "#C55A10", "#A464C3",
